...
$("#addRecepcion").click(function(){
    ...
    var imagen=document.getElementById("imagenCanvasIzq"); 
    imagen.value=document.getElementById("canvasIzq").toDataURL('image/png');

    var imagen1=document.getElementById("imagenCanvasDer"); 
    imagen1.value=document.getElementById("canvasDer").toDataURL('image/png');

    var imagen2=document.getElementById("imagenCanvasArriba"); 
    imagen2.value=document.getElementById("canvasArriba").toDataURL('image/png');

    var imagen3=document.getElementById("imagenCanvasSeat"); 
    imagen3.value=document.getElementById("canvasSeat").toDataURL('image/png');

    var imagen4=document.getElementById("imagenCanvasFrente"); 
    imagen4.value=document.getElementById("canvasFrente").toDataURL('image/png');

    var imagen5=document.getElementById("imagenCanvasInterior"); 
    imagen5.value=document.getElementById("canvasInterior").toDataURL('image/png');
    ...
    $("input[type=radio]").each(function(){
        ...
        if(this.checked){     
            ...
            if (porci[0]=="tab" || porci[0]=="enc" || porci[0]=="ala" || porci[0]=="carga" || porci[0]=="aire") {
                var canti="0";
                adic[y] = valor;
                y++;

            }else{   
                var canti = document.getElementById((z+1)+"_3").value;             
    ...
    if(error == 0){
        ...
        $.ajax({
            ...
            data: {
                ...
                "imagenCanvasIzq"  :  $("#imagenCanvasIzq").val(),
                "imagenCanvasDer"  :  $("#imagenCanvasDer").val(),
                "imagenCanvasArriba"  :  $("#imagenCanvasArriba").val(),
                "imagenCanvasSeat"  :  $("#imagenCanvasSeat").val(),
                "imagenCanvasFrente"  :  $("#imagenCanvasFrente").val(),
                "imagenCanvasInterior"  :  $("#imagenCanvasInterior").val(),
                "func"          :  "addRecepcion",
                "adic"          :  adic,
                "access"        :  access,
                "cantiad"       :  acount,
...
function editRecepcion(elemento, id){   
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#formNPerfil").css("display","block");
            $("#formEPerfil").css("display","block");
            $(".tabla-completa").css("opacity","0");
            $("html, body").animate({ scrollTop: 0 }, 600);


            loadAccesorios(valor);
            loadMotivo(valor);
            loadAsesor(valor);
    ...
    $("input[type=radio]").each(function(){
        ...
        if(this.checked){            
            ...
            if (porci[0]=="etab" || porci[0]=="eenc" || porci[0]=="eala" || porci[0]=="ecarga" || porci[0]=="eaire" ) {
                ...
                var canti = document.getElementById(("e"+(z+1)+"_3")).value;       
                access[z] = valor.concat('_',canti);
                z++;
            }       
            acc[x] = valor.concat('_',canti);
