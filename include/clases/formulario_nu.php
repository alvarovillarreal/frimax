...
public function createPage(){
    ...
    private function getFormNPerfil(){
        ...
        <span type="button" name="clearFirma" class="btn btn-xs btn-danger" id="btnCanvasFrente">Clear</span>
        </div> 
        <div class="form-group  col-md-4 col-sm-6 col-xs-12 centrado">
    ...
    private function getFormEPerfil(){
        ...
        <div class="box box-warning">
        <div class="box-header">
        <h3 class="box-title">Estatus e imágenes de seguimiento</h3>
        </div>
        <div class="box-body">
        <form role="form" id="uploadPictures">
        <div class="form-group col-md-4">
        <label></label>
        <div id="estatusActual"></div>
        </div>
        <div class="form-group col-md-4">
        <label>Siguiente Estatus Actual</label>
        ...
        if($this->level!= 5){
            ...
            <div class="form-group col-md-4">
            <label>Fotos Identificación</label>
        ...
        <button type="button" class="btn btn-primary" id="updRecepcion" name="addRecepcion">Guardar</button>
        <button type="button" class="btn btn-primary" id="cancelar" name="cancelar">Cancelar</button>
        </div>
        </div>
        </div>
  ...
  private function getAccesorios($tipo=""){
    ...
    while($dat = parent::fetch_array($sql)){
        ...
        <input type="number" min="0" max="9" class="form-control" value="0" name="'.$dat['nombre'].'" id="'.$tipo.$dat['id'].'_3">
            ...
            // R  <input type="radio" class="'.$tipo.$dat['id'].'_3" name="'.$dat['nombre'].'" id="'.$tipo.$dat['id'].'_3"/>
    }
