...
class pagina extends MySQL{
	...
	private function getCSS(){
		...
		if($this->subseccion == "adminUsers" || $this->subseccion == "perfiles" || $this->subseccion == "sucursales" || $this->subseccion == "recepcion" || $this->subseccion == "accesorios" || $this->subseccion == "usuarios"){
			$dato = '
			...
			<link href="'.parent::getPath().'plugins/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
	...
	private function getJS(){
		...
		if($this->subseccion == "adminUsers" || $this->subseccion == "perfiles" || $this->subseccion == "sucursales" || $this->subseccion == "recepcion" || $this->subseccion == "accesorios" || $this->subseccion == "usuarios"){
			...
			$(function () {
				...
				<script src="'.parent::getPath().'js/canvas.js" type="text/javascript"></script>';
			}
	...
	//Devuelve el footer de la pagina
		private function getFooter(){
			...
			<strong>Copyright &copy; 2017 <a href="frimax.mx">Frimax</a></strong> Todos los derechos reservados.
			</footer>';
