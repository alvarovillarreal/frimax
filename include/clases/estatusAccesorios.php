...
class estatusAccesorios extends pagina{
	            			...
	            			<div class="box-body">
	                  			<table id="example1" class="table table-bordered table-striped">
	                    			...
	                    			while($inf = parent::fetch_array($sql)){
	                    				...
	                    				<tr>
	                        				<td>'.$inf['id'].'</td>
					                        <td>'.utf8_encode($inf['descripcion']).'</td>
					                        <td>'.$status.'</td>
					                        <td>'.$botones.'</td>
		...
		<div class="col-md-6 col-sm-12" id="formNPerfil" style="display:none">
            <div class="box-footer">
            	<div class="box-header">
                    <h3 class="box-title">Información Nuevo Estatus Accesorios</h3>
                </div>
                <div class="box-body">
                    <form role="form">
                ...
                <button type="button" class="btn btn-primary" id="addEstatusAccesorio">Guardar Nuevo Estatus</button>
            ...
            <div class="box-footer">
                ...
                <div class="box-body">
                    <form role="form">
                        ...
                        <div class="form-group">
                            <label>Nombre Estatus</label>
                            <input type="text" class="form-control" id="nombreEstatusAccesorio" name="nombreEstatusAccesorio"/>
                        </div>
                    </form>
                </div>
                <button type="button" class="btn btn-primary" id="SendEditEstatusAccesorio">Guardar Estatus</button>
                <button type="button" class="btn btn-primary hideForms">Cancelar</button>
            </div>
        </div>';
	...
	private function getSQL(){
		$sql = '
			SELECT * FROM in_estatusAccesorios ';
	...
	private function getBotones($tipo, $id){
		$dato = '
			<a href="#" class="editEstatusAccesorio" id="'.$id.'"><i class="fa fa-edit"></i> Editar </a><br />
			<a href="#" class="elimEstatusAccesorio" id="'.$id.'"><i class="fa fa-trash"></i> Eliminar </a><br />';

		if($tipo == 1){//Entra porque esta activo
			$dato .= '<a href="#" class="susEstatusAccesorio" id="'.$id.'"><i class="fa fa-warning"></i> Suspender </a><br />';
		}
		elseif($tipo == 2){//Entra porque esta inactivo
			$dato .= '<a href="#" class="actEstatusAccesorio" id="'.$id.'"><i class="fa fa-check"></i> Activar </a><br />';
		}
		elseif($tipo == 9 AND $this->level == "1"){
			$dato .= '<a href="#" class="actEstatusAccesorio" id="'.$id.'"><i class="fa fa-check"></i> Re-Activar </a><br />';
		}
	...
	private function getTitulo(){
        ...
        <section class="content-header">
          <h1>
            Lista de Estatus de Accesorios
            <small><button type="button" class="btn btn-primary" id="showPerfil">Nuevo Estatus de Accesorios</button></small>
          </h1>
          '.$this->getTimeLine().'
        </section>';
    ...
    private function getTimeLine(){
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Lista de Estatus de Accesorios</a></li>
        </ol>';
...
$pagina = new estatusAccesorios($section, $subsection);
